...
namespace SORCE.Challenges.C_Buildings
{
    public class Brixton : BuildingsChallenge
	{
		...
		public override string WallFence =>			null;
		public override string WallStructural =>	VWall.Brick;

		public override bool WallsFlammable =>		false;

        public override string FloorConstructed =>	VFloor.BrickIndoor;
		public override string FloorNatural =>		null;
        public override string FloorRaised =>		VFloor.BrickIndoor;
		public override string FloorRug =>			null;
		public override string FloorUnraisedTile =>	VFloor.BrickIndoor;
